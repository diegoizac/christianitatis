...
const Navbar = () => {
  ...
  return (
    <nav
      className={`pt-4 px-4 sm:px-6 lg:px-8 transition-all duration-700 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-10'}`}
    >
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center">
          <div className="flex-shrink-0">
            <a
              href="/"
              className="text-white text-3xl font-bold hover:text-opacity-90 transition-all"
            >
              Christianitatis
            </a>
          </div>
